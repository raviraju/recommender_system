...
class RandomBasedRecommender(RecommenderIntf):
    ...
    def __init__(self, results_dir, model_dir,
        ...
        self.model_file = os.path.join(self.model_dir, 'random_based_model.pkl')
    ...
    def train(self):
        ...
        self.recommendations = random.sample(set(self.train_data[self.item_id_col].unique()),
                                             self.no_of_recs)
    ...
    def recommend_items(self):
        ...
        start_time = default_timer()
        recommended_items = self.recommendations
        end_time = default_timer()
    ...
    def __generate_top_recommendations(self):
        """Generate top random recommendations"""
        recommended_items = self.recommendations
        return recommended_items
