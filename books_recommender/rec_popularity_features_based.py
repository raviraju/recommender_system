...
class Books_PopularityBasedRecommenderFeatures(popularity_based_features.PopularityBasedRecommenderFeatures):
...
def train_eval_recommend(results_dir, model_dir, train_test_dir,
    ...
    model = Books_PopularityBasedRecommenderFeatures(results_dir, model_dir,
                                                     train_data, test_data,
                                                     user_id_col, item_id_col,
                                                     features, no_of_recs)
    model.train()
