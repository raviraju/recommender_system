...
def extract_learner_books(bookclub_events):
    ...
    learner_book_dataframe = dataframe.groupby(['learner_id','book_code']).size().reset_index().rename(columns={0:'events_count'})
