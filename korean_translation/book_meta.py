...
TRANSLATIONS_FILE = 'translation_dir/translations.json'
...
def main():
    ...
    if args.store:
        ...
        if not os.path.isdir('output'):
            os.makedirs('output')
        t_data_csv = os.path.join('output', 'T_' + data_csv)
        book_meta_data.to_csv(t_data_csv, index=False)
    else:
