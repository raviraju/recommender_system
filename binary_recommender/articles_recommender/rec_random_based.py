"""Module for Random Based Articles Recommender"""
import os
import sys
...
class RandomBasedRecommender(articles_rec_interface.ArticlesRecommender,
                             generic_rec_random_based.RandomBasedRecommender):
    """Random based recommender system model for Articles"""
...
def main():
    ...
    model_name = 'models/' + kwargs['hold_out_strategy'] + '_random_based'
