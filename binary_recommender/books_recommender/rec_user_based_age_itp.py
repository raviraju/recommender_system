...
def main():
    ...
    if args.age_or_itp == 'itp':
        ...
        model_dir = os.path.join(current_dir, model_name_prefix + '_user_based_itp')
    if args.age_or_itp == 'age':
        kwargs['age_or_itp'] = 'age'
        model_dir = os.path.join(current_dir, model_name_prefix + '_user_based_age')
    if args.age_or_itp == 'age_and_itp':
        kwargs['age_or_itp'] = 'age_and_itp'
        model_dir = os.path.join(current_dir, model_name_prefix + '_user_based_age_itp')
